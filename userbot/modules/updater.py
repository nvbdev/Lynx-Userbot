...
async def upstream(event):
    ...
    if conf is None and force_update is False:
        changelog_str = f'**Pembaruan Untuk ⚡𝗟𝘆𝗻𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡ :\n\n💻 Pembaruan Data :**\n`{changelog}`'
        ...
        return await event.respond('**Perintah Untuk Update, Sebagai Berikut :**\n ⚡𝘾𝙈𝘿⚡: `.update -pull`\n ⚡𝘾𝙈𝘿⚡: `.update -push`\n\n__Untuk Meng-Update Fiture Terbaru Dari ⚡𝗟𝘆𝗻𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡.__')

    if force_update:
        await event.edit(
            '`Sinkronisasi Paksa Ke Kode Userbot Stabil Terbaru, Harap Tunggu .....`')
    else:
        await event.edit('` Proses Update ⚡𝗟𝘆𝗻𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡, Loading....1%`')
        await event.edit('` Proses Update ⚡𝗟𝘆𝗻𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡, Loading....20%`')
